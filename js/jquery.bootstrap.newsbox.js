...
(function ($, w, d, undefined) {
  var NewsBox = {
    ...
    buildNavigation: function () {
      ...
      if (panel) {
        var nav =
          '<ul class="update_arrow pull-right" style="margin: 0px;">' +
          '<li><a href="#" class="prev"><i class="far fa-arrow-alt-circle-up"></i></a></li>' +
          '<li><a href="#" class="next"><i class="far fa-arrow-alt-circle-down"></i></a></li>' +
          '</ul><div class="clearfix"></div>';

        var footer = $(panel).find(".update_footer")[0];
        if (footer) {
          $(footer).append(nav);
        } else {
          $(panel).append('<div class="update_footer">' + nav + "</div>");
        }
